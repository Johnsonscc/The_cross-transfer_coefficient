...
# 文件路径
INITIAL_MASK_PATH = "../lithography_simulation_Hopkins/data/input/cell4.png"
TARGET_IMAGE_PATH = "../lithography_simulation_Hopkins/data/input/cell4.png"
OUTPUT_MASK_PATH = "../lithography_simulation_Hopkins/data/output/optimized_mask_cell4.png"
RESULTS_IMAGE_PATH = "../lithography_simulation_Hopkins/data/output/results_comparison_cell4.png"
FITNESS_PLOT_PATH = "../lithography_simulation_Hopkins/data/output/fitness_evolution_cell4.png"
